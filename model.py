...
#  The network is designed to use teacher forcing to get a sequence to sequence prediction (input seq to output seq) instead of backpropogation through time
# For more info read this article https://machinelearningmastery.com/teacher-forcing-for-recurrent-neural-networks/
# It has a really good explanation of Teacher Forcing
